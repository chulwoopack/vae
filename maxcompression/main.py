...
flags.DEFINE_string('save_dir', '/work/cse496dl/cpack/Assignment_3/models/2/maxcompression_encoder_homework_3-0', 'directory where VAE model graph and weights are saved')
...
with tf.Session() as sess:
    ...
    for i in range(test_data.shape[0]):
        inputs_out, output_out = session.run([inputs, outputs], {inputs: np.expand_dims(test_data[i], axis=0)})
